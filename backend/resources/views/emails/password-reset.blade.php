...
<script>
    document.getElementById('resetForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                msgDiv.className = 'mt-2 text-sm text-center text-green-600';
                msgDiv.innerText = 'Đổi mật khẩu thành công! Bạn có thể đóng trang này.';
                msgDiv.classList.remove('hidden');
            } else {
                msgDiv.className = 'mt-2 text-sm text-center text-red-600';
