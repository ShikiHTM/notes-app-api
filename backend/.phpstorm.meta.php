...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'scribe.apply.response_calls.methods' => 'array',
...
'cache.serializable_classes','cloudinary.name','cloudinary.api_key','cloudinary.api_secret','cloudinary.secure',
...
'scout.typesense.client-settings.healthcheck_interval_seconds','scout.typesense.client-settings.num_retries','scout.typesense.client-settings.retry_interval_seconds','scout.typesense.model-settings','scout.typesense.import_action',
...
'scribe.apply.response_calls.methods','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'scribe','scribe.postman','scribe.openapi','sanctum.csrf-cookie','verification.verify','images.index','images.store',
'images.destroy','notes.index','notes.store',
'notes.show','notes.update','notes.destroy','labels.index','labels.store',
'labels.show','labels.update','labels.destroy',
'reset-password','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.forgot_password','emails.password-reset','scribe.index','welcome','laravel-exceptions-renderer::components.badge',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','CLOUDINARY_NAME','CLOUDINARY_API_KEY','CLOUDINARY_API_SECRET',
'CLOUDINARY_API_SECURE','CLOUDFLARE_TUNNEL_TOKEN','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_KEY',
'VITE_APP_NAME',);
