...
const ToastItem: React.FC<IToast> = ({ id, message, type, isLeaving }) => {
    ...
    return (
        <div
            className={`pointer-events-auto flex items-center p-4 rounded-lg border shadow-lg ${isLeaving ? "animate-out fade-out zoom-out-95 slide-out-to-right-4 duration-200" : "animate-in fade-in zoom-in-95 slide-in-from-right-4 duration-300"} ${config.bg} ${config.text}`}
        >
