...
export const ModalContext = React.createContext<IModalContextType | undefined>(undefined);

export function ModalProvider({ children }: { children: React.ReactNode }) {
    const [state, setState] = React.useState<{ opts: IConfirmOpts, resolve: (value: boolean) => void } | null>(null);
